...
description: "面试助手：调研目标公司、生成定制面试题、模拟面试、STAR评分、AI面试官轮应对、答案去AI味。Interview prep skill: research companies with evidence discipline, generate tailored questions, run mock interviews, evaluate with calibrated STAR scoring, prep for AI-interviewer rounds, humanize prepared answers. Use whenever the user mentions an upcoming interview, job application, resume vs JD match, mock interview, behavioral/STAR practice, LeetCode prep for a company, AI screening/async video interview, offer/debrief — even if they don't say 'interview prep' explicitly (e.g. 'I have a Google onsite next week', '帮我看看这个JD', '明天要面字节')."
license: MIT
user-invocable: true
